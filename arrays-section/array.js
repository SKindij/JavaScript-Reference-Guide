...
// reducing
const arrayBots = ['voltron', 'optimus', 'megatron', 'genesius'];
const stringBots = arrayBots.reduce((result, item) => `${result} & ${item}`);
  console.log(stringBots); // => 'voltron & optimus & megatron & genesius'
